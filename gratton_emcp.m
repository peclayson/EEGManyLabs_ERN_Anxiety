...
%   Version 0.6 June 2012, clean up some stuff to share code,
...
% can use this code to show what points are identified as blinks in chan
% 62, also shows the slope and covariance measures
% EEG.data(27,markBlink) = 100;
% EEG.data(27,~markBlink) = 0;
% EEG.data(28,:,:) = abs(slope);
% EEG.data(29,:,:) = covariance;
